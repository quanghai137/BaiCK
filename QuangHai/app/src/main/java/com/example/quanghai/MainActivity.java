...
public class MainActivity extends AppCompatActivity {
    ...
    private void bottomNavigation(){
        ...
        LinearLayout MessageBtn = findViewById(R.id.MessageBtn);
    ...
    private void recyclerViewPopular(){
        ...
        foodList.add(new FoodDomain("Pizza personal",R.drawable.pizza,"Món ăn rất được ưa chuộng tại các nước châu Âu, thành phần chủ yếu là bột mỳ nhưng không kém phần dinh dưỡng",3.23,1));
